  ...
  return (
    <div className="fixed bottom-6 right-5 z-50 flex flex-col gap-3 items-center">
      ...
      <a
        ...
        className="group flex items-center justify-center w-12 h-12 rounded-full shadow-lg transition-transform duration-300 hover:scale-110"
      ...
      <a
        ...
        className="group flex items-center justify-center w-12 h-12 rounded-full bg-[#25D366] shadow-lg transition-transform duration-300 hover:scale-110"
      >
        {/* WhatsApp SVG icon */}
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" className="w-5 h-5">
